...
const handlerWrapperArgs = { functionName: 'task-processing-dev-websocketHandler', timeout: 6 };

try {
  const userHandler = require('./apps/backend/functions/websocketHandler/index.js');
