...
const handlerWrapperArgs = { functionName: 'task-processing-dev-streamProcessor', timeout: 6 };

try {
  const userHandler = require('./apps/backend/functions/streamProcessor/index.js');
