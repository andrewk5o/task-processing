...
export class TasksApiService {
  ...
  private readonly apiUrl = 'https://3ac9xpts03.execute-api.eu-central-1.amazonaws.com/tasks';
  private readonly websocketUrl = 'wss://8pd3n4iow3.execute-api.eu-central-1.amazonaws.com/dev';
